...
if(n==1) %plots all 15 Vout against time
    ...
    [t,Vout]=ralston(Vin,iL0,h,R,L,ti,tf); %obtain arrays of Vout and t using ralston method
    subplot(3,2,1);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=5.5V')
...
if(n==2)
    ...
    subplot(3,2,2);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=Vin exp(-t^2/tau)')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==3)
    ...
    subplot(3,2,3);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=Vin exp(-t/tau)')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==4)
    ...
    subplot(3,4,1);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sin(2pit/T) T = 20e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==5)
    ...
    subplot(3,4,2);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sin(2pit/T) T = 160e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==6)
    ...
    subplot(3,4,3);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sin(2pit/T) T = 450e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==7)
    ...
    subplot(3,4,4);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sin(2pit/T) T = 1000e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==8)
    ...
    subplot(3,4,5);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5square(2pit/T) T = 20e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==9)
    ...
    subplot(3,4,6);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5square(2pit/T) T = 160e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==11)
    ...
    subplot(3,4,8);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5square(2pit/T) T = 1000e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==12)
    ...
    subplot(3,4,9);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sawtooth(2pit/T) T = 20e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==13)
    ...
    subplot(3,4,10);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sawtooth(2pit/T) T = 160e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==14)
    ...
    subplot(3,4,11);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sawtooth(2pit/T) T = 450e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
...
if(n==15)
    ...
    subplot(3,4,12);
    plot(t,Vout); % plot Vout against t
    title('Ralston Vin=4.5sawtooth(2pit/T) T = 1000e-6s')
    xlabel('Time [s]') % x-axis label
    ylabel('Vout [V]') % y-axis label
end
